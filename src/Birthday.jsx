...
const Birthday = ({ name, day, month }) => {
  ...
  if (name === undefined || day === undefined || month === undefined) {
    name = 'Pankaj'; // Name of the Person
  ...
  return (
    <div className='page'>
      <img src={img} alt="bimage" className="_img"/><br/>
      ...
      {!isItBday && (
        <>
          ...
          <div className='credits'>
            <a href='https://github.com/Deep-Codes' onClick={(e) => { e.preventDefault() }}>
              <img src={githubLogo} alt='Github-Logo' className='github-logo' />
            </a>
          </div>
          <Link to='#' className="blink">Hritik Raj</Link>
        </>
      )}
    </div>
  );
